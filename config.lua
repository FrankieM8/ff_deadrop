...
Config.Payphones = {
    ...
    Locations = {
        vector4(170.05, -995.12, 29.35, 69.0),
        vector4(268.89, -824.23, 29.29, 340.0),
        vector4(-555.36, -185.58, 38.22, 210.0),
        vector4(-1213.05, -330.44, 37.79, 296.0),
        vector4(1136.43, -982.20, 46.42, 95.0),
        vector4(1688.11, 3757.78, 34.71, 130.0),
        vector4(-49.51, 6526.62, 31.49, 45.0),
    },
}
